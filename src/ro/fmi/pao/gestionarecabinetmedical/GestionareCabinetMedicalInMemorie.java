...
public class GestionareCabinetMedicalInMemorie extends GestionareCabinetMedical {
    ...
    public void actionPerformed(ActionEvent actionEvent) {
        ...
        if (actionEvent.getSource() == btn1) {
            CitireSpecializareMedic.getInstance(GestionarePersoaneInMemorie.getInstance(), GestionareCabinetMedicalInMemorie.getInstance()).faVizibil();
        } else if (actionEvent.getSource() == btn2) {
            CitirePersoana.getInstance(GestionarePersoaneInMemorie.getInstance(), GestionareCabinetMedicalInMemorie.getInstance()).faVizibil();
        } else if (actionEvent.getSource() == btn3) {
            CitireProgramare.getInstance(GestionarePersoaneInMemorie.getInstance(), GestionareProgramariInMemorie.getInstance(), GestionareCabinetMedicalInMemorie.getInstance()).faVizibil();
        } else if (actionEvent.getSource() == btn4) {
            new FrameRaspuns("Toti medicii", GestionarePersoaneInMemorie.getInstance().getTotiMedicii().toString(), GestionareCabinetMedicalInMemorie.getInstance());
        } else if (actionEvent.getSource() == btn5) {
            new FrameRaspuns("Toti clientii", GestionarePersoaneInMemorie.getInstance().getTotiClientii().toString(), GestionareCabinetMedicalInMemorie.getInstance());
        } else if (actionEvent.getSource() == btn6) {
            CitireCodParafaAfisareMedic.getInstance(GestionarePersoaneInMemorie.getInstance(), GestionareCabinetMedicalInMemorie.getInstance()).faVizibil();
        } else if (actionEvent.getSource() == btn7) {
            CitireCnpAfisareClient.getInstance(GestionarePersoaneInMemorie.getInstance(), GestionareCabinetMedicalInMemorie.getInstance()).faVizibil();
        } else if (actionEvent.getSource() == btn8) {
            CitireCodProgramareAnulareProgramare.getInstance(GestionareProgramariInMemorie.getInstance(), GestionareCabinetMedicalInMemorie.getInstance()).faVizibil();
        } else if (actionEvent.getSource() == btn9) {
            CitireCodParafaDataAfisareProgramari.getInstance(GestionarePersoaneInMemorie.getInstance(), GestionareProgramariInMemorie.getInstance(), GestionareCabinetMedicalInMemorie.getInstance()).faVizibil();
        } else if (actionEvent.getSource() == btn10) {
            CitireCnpAfisareProgramari.getInstance(GestionareProgramariInMemorie.getInstance(), GestionareCabinetMedicalInMemorie.getInstance()).faVizibil();
        } else if (actionEvent.getSource() == btn11) {
            CitireCodSpecializareAfisareMedici.getInstance(GestionarePersoaneInMemorie.getInstance(), GestionareCabinetMedicalInMemorie.getInstance()).faVizibil();
        } else {
            jFrame.dispose();
        }
    }
